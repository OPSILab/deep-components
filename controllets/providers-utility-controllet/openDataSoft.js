...
openDataSoft_Provider.prototype.getHTMLFormattedMetadata = function(dataset, resourceIndex) {
    ...
    html += '<b>' + ln["resourceName_" + ln["localization"]] + ':</b> <b style="color: #8baf27;">' + dataset.title + '</b><br>';
    html += '<b>' + ln["resourceDescription_" + ln["localization"]] + ':</b>' + dataset.description + '</b><div style="height: 1px; background: #8baf27; margin: 12px 0;"></div>';
